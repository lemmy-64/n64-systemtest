...
impl Test for ADDI {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        ...
        assembler.write_addi(GPR::S0, GPR::V0, 0x1234);
        assembler.write_addi(GPR::S1, GPR::V0, 0x0072);
        assembler.write_addi(GPR::S2, GPR::V0, 0x0000);
        assembler.write_addi(GPR::S3, GPR::V0, -1);

        assembler.write_addi(GPR::S4, GPR::V1, 0x1234);
        assembler.write_addi(GPR::S5, GPR::V1, 0x0072);
        assembler.write_addi(GPR::S6, GPR::V1, 0x0000);
        assembler.write_addi(GPR::S7, GPR::V1, -1);
        ...
        assembler.write_addi(GPR::R0, GPR::V1, 123);
