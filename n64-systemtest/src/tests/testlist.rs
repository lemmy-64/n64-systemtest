...
fn default_tests() -> Vec<Box<dyn Test>> {
    vec! {
        ...
        Box::new(super::memory_instructions::LL {}),
        Box::new(super::memory_instructions::LLIntoR0 {}),
        Box::new(super::memory_instructions::LLD {}),
        Box::new(super::memory_instructions::LLDIntoR0 {}),
        Box::new(super::memory_instructions::SC {}),
        Box::new(super::memory_instructions::SCWithoutLL {}),
        Box::new(super::memory_instructions::SCD {}),
        Box::new(super::memory_instructions::SCDWithoutLL {}),
