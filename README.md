...
- LLD/LD/SC/SCD
- TLB
- 32/16/8 bit access to RAM, ROM, SPMEM and PIF
- Exceptions: Overflow (ADD, DADD etc), unaligned memory access (e.g. LW), TRAP, BREAK, SYSCALL
- Weird delay behavior (e.g. what happens if a branch is itself within a delay slot)
- Some RSP behavior
