...
impl Test for TLBAndAddressError64 {
    ...
    fn values(&self) -> Vec<Box<dyn Any>> {
        vec! {
            ...
            Box::new((false, 0x00000000_00000001u64)),
            ...
            Box::new((false, 0xC00000FF_7FFFFFFBu64)),
            ...
            Box::new((false, 0xC00000FF_F0000005u64)),
