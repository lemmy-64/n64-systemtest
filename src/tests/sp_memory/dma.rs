...
fn dma_test<const N: usize>(source_index: usize, spmem_index: u32, length: u32, expected_start_offset: usize, expected: [[u16; 8]; N]) -> Result<(), String> {
