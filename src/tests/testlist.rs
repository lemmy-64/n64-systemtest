...
fn default_tests() -> Vec<Box<dyn Test>> {
    vec! {
        ...
        Box::new(super::address_error_exception::UnalignedJumpWithDelaySlot {}),
        ...
        Box::new(super::arithmetic::ll_sc::LL {}),
        ...
        Box::new(super::cart_memory::dma::PIDMASmallSize {}),
        Box::new(super::cart_memory::dma::PIDMAMisaligned {}),
        Box::new(super::cart_memory::dma::PIDMAMisalignedCrossPage {}),
        Box::new(super::cart_memory::dma::PIDMAMisalignedEndOfPage {}),
        ...
        Box::new(super::cop0::IcacheStoreTagThenLoadTag {}),
        Box::new(super::cop0::IcacheIndexInvalidateClearsValidInTagLo {}),
        Box::new(super::cop0::IcacheHitInvalidateClearsValidWhenLineHits {}),
        Box::new(super::cop0::IcacheFetchUsesMemoryImage {}),
        Box::new(super::cop0::IcacheUncachedPatchStallsUntilInvalidate {}),
        Box::new(super::cop0::IcacheFillOpcodeLoadsLineFromRam {}),
        Box::new(super::cop0::IcacheHitWritebackPushesLineToRam {}),
        Box::new(super::cop0::DcacheLoadWordMatchesUncachedInit {}),
        Box::new(super::cop0::DcacheStaleAfterUncachedStore {}),
        Box::new(super::cop0::DcacheHitWritebackWritesDirtyToRam {}),
        Box::new(super::cop0::DcacheStoreTagThenLoadTag {}),
        Box::new(super::cop0::DcacheIndexWbInvClearsValidInTagLo {}),
        Box::new(super::cop0::DcacheCreateDirtyExclusiveThenStore {}),
        Box::new(super::cop0::DcacheHitWritebackInvalidate {}),
        ...
        Box::new(super::privilege::EnterUserModeAndReturnKernel {}),
        Box::new(super::privilege::EnterSupervisorModeAndReturnKernel {}),
        ...
        Box::new(super::endian_re::ReUnaligned32BitLoads {}),
        Box::new(super::endian_re::ReUnaligned32BitStores {}),
        Box::new(super::endian_re::ReUnaligned64BitLoads {}),
        Box::new(super::endian_re::ReUnaligned64BitStores {}),
        ...
        Box::new(super::mi::repeat::SB {}),
        Box::new(super::mi::repeat::SH {}),
        Box::new(super::mi::repeat::SW {}),
        Box::new(super::mi::repeat::SD {}),
        Box::new(super::mi::repeat::Wrap2KiB {}),
		...
		Box::new(super::rsp::op_vector_loads::LFVZeroExtended {}),
		...
		Box::new(super::rsp::op_vrndp::VRNDPClampNegativeAccumulator {}),
		...
		Box::new(super::rsp::op_vrndn::VRNDNClampNegativeAccumulator {}),
        ...
        Box::new(super::sp_memory::dma::SPDMAMultiRowIMEMRoundtrip {}),
        ...
        Box::new(super::tlb::cross_page_exec::CrossPageExecLinear32 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecLinear64 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecBeqDelay32 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecBeqDelay64 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecJrDelay32 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecJrDelay64 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecBranchInBranch32 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecBranchInBranch64 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecBranchInBranchInnerPage32 {}),
        Box::new(super::tlb::cross_page_exec::CrossPageExecBranchInBranchInnerPage64 {}),
        Box::new(super::tlb::exceptions::ExecuteTLBMappedMiss {}),
        Box::new(super::tlb::exceptions::ExecuteTLBMappedMissInDelay {}),
        Box::new(super::tlb::exceptions::TlbMissFetchAfterEret {}),
