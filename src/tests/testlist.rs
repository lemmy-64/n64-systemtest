...
fn default_tests() -> Vec<Box<dyn Test>> {
    vec! {
        ...
        Box::new(super::rsp::op_vector_arithmetic::VABSQ1 {}),
        Box::new(super::rsp::op_vector_arithmetic::VADDC {}),
        Box::new(super::rsp::op_vector_arithmetic::VADDCH3 {}),
        Box::new(super::rsp::op_vector_arithmetic::VSUBC {}),
        Box::new(super::rsp::op_vector_arithmetic::VSUBCE1 {}),
        ...
        Box::new(super::rsp::op_vector_arithmetic::VLTAllEqualAndFlags {}),
        Box::new(super::rsp::op_vector_arithmetic::VLTAllSmallerAndFlags {}),
        Box::new(super::rsp::op_vector_arithmetic::VLTAllLargerAndFlags {}),
        Box::new(super::rsp::op_vector_arithmetic::VEQ {}),
        Box::new(super::rsp::op_vector_arithmetic::VEQAllDifferent {}),
        Box::new(super::rsp::op_vector_arithmetic::VEQAllEqual {}),
        Box::new(super::rsp::op_vector_arithmetic::VNE {}),
        Box::new(super::rsp::op_vector_arithmetic::VNEAllDifferent {}),
        Box::new(super::rsp::op_vector_arithmetic::VNEAllEqual {}),
