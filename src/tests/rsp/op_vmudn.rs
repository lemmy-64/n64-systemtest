...
fn run_test(e: Element, expected_result: [u16; 8], expected_acc_top: [u16; 8], expected_acc_mid: [u16; 8], expected_acc_low: [u16; 8]) -> Result<(), String> {
    ...
    soft_assert_eq(SPMEM::read_vector_16(0x100), expected_result, "VMUDN result")?;
    soft_assert_eq(SPMEM::read_vector_16(0x110), expected_acc_top, "VMUDN Acc[32..48]")?;
    soft_assert_eq(SPMEM::read_vector_16(0x120), expected_acc_mid, "VMUDN Acc[16..32]")?;
    soft_assert_eq(SPMEM::read_vector_16(0x130), expected_acc_low, "VMUDN Acc[0..8]")?;
