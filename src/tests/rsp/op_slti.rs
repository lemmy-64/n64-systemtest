...
// SLTI sign extends the immediate to 32 bit and then does a signed comparison

pub struct SLTI {}

impl Test for SLTI {
    fn name(&self) -> &str { "RSP SLTI" }
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        ...
        assembler.write_slti(GPR::S0, GPR::V0, 0x0000u16 as i16);
        assembler.write_slti(GPR::S1, GPR::V0, 0x0001u16 as i16);
        assembler.write_slti(GPR::S2, GPR::V0, 0xFFFFu16 as i16);

        assembler.write_slti(GPR::S3, GPR::V1, 0x0010u16 as i16);
        assembler.write_slti(GPR::S4, GPR::V1, 0x0011u16 as i16);
        assembler.write_slti(GPR::S5, GPR::V1, 0x0009u16 as i16);
        assembler.write_slti(GPR::S6, GPR::V1, 0xFFFEu16 as i16);
        ...
        assembler.write_slti(GPR::R0, GPR::V0, 1);
        ...
        soft_assert_eq(SPMEM::read(0x08), 0, "0x00000000 < 0xFFFF")?;
        ...
        soft_assert_eq(SPMEM::read(0x18), 0, "0x00000010 < 0xFFFE")?;
