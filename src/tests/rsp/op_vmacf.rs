...
fn run_test(e: Element, expected_result: [u16; 8], expected_acc_top: [u16; 8], expected_acc_mid: [u16; 8], expected_acc_low: [u16; 8]) -> Result<(), String> {
    ...
    soft_assert_eq(SPMEM::read_vector_16(0x100), expected_result, "VMACF result")?;
    soft_assert_eq(SPMEM::read_vector_16(0x110), expected_acc_top, "VMACF Acc[32..48]")?;
    soft_assert_eq(SPMEM::read_vector_16(0x120), expected_acc_mid, "VMACF Acc[16..32]")?;
    soft_assert_eq(SPMEM::read_vector_16(0x130), expected_acc_low, "VMACF Acc[0..8]")?;
...
impl Test for VMACFAccumulatorOverflowed {
    ...
    fn run(&self, _value: &Box<dyn Any>) -> Result<(), String> {
        ...
        soft_assert_eq(SPMEM::read_vector_16(0x110), [0x8000, 0x8001, 0, 0, 0, 0, 0, 0], "VMACF Acc[32..48] after accumulator overflow in [0]")?;
        soft_assert_eq(SPMEM::read_vector_16(0x120), [0, 0, 0, 0, 0, 0, 0, 0], "VMACF Acc[16..32] after accumulator overflow in [0]")?;
        ...
        soft_assert_eq(SPMEM::read_vector_16(0x150), [0x8001, 0x7FFF, 0, 0, 0, 0, 0, 0], "VMACF Acc[32..48] after accumulator overflow in [1]")?;
        soft_assert_eq(SPMEM::read_vector_16(0x160), [0x8000, 0x8003, 0, 0, 0, 0, 0, 0], "VMACF Acc[16..32] after accumulator overflow in [1]")?;
