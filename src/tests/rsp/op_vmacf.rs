...
fn run_test(e: Element, expected_result: [u16; 8], expected_acc_top: [u16; 8], expected_acc_mid: [u16; 8], expected_acc_low: [u16; 8]) -> Result<(), String> {
    ...
    assembler.write_vmulf(VR::V2, VR::V0, VR::V1, Element::All);
    assembler.write_vmacf(VR::V6, VR::V6, VR::V1, e);
    assembler.write_vmulf(VR::V2, VR::V0, VR::V1, Element::All);
    assembler.write_vmacf(VR::V7, VR::V0, VR::V7, e);
    ...
    soft_assert_eq(SPMEM::read_vector16_from_dmem(0x130), expected_acc_low, "VMACF Acc[0..16]")?;
    soft_assert_eq(SPMEM::read_vector16_from_dmem(0x140), expected_result, "VMACF result when doing VMACF V6, V6, V1")?;
    soft_assert_eq(SPMEM::read_vector16_from_dmem(0x150), expected_result, "VMACF result when doing VMACF V7, V0, V7")?;
